...
class KafkaConsumer:
    ...
    def __init__(
        ...
        #  reference the project README and use the Host URL for Kafka and
        #  Schema Registry!
        ...
        #  sure to think about how the `on_assign` callback should be invoked.
    ...
    def _consume(self):
        """Polls for a message. Returns 1 if a message was received, 0
        otherwise"""
